...
if ((req.status_code == 200) and (not strong[0].getText())) or (req.status_code!=200):
	...
	print(Style.BRIGHT + strong[6].getText()+'%16s'%strong[7].getText()+'%16s'%strong[8].getText())
	print(strong[9].getText()+'%16s'%strong[10].getText()+'%16s'%strong[11].getText())
	print(strong[12].getText()+'%16s'%strong[13].getText()+'%16s'%strong[14].getText())
	print(strong[15].getText()+'%16s'%strong[16].getText()+'%16s'%strong[17].getText())
	print(strong[18].getText()+'%16s'%strong[19].getText()+'%16s'%strong[20].getText())
	print(strong[21].getText()+'%16s'%strong[22].getText()+'%16s'%strong[23].getText())
	print(strong[24].getText()+'%16s'%strong[25].getText()+'%16s'%strong[26].getText())
	print(strong[27].getText()+'%16s'%strong[28].getText()+'%16s'%strong[29].getText())
print("")	
print("")	
